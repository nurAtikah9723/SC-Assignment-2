...
<!------------------- Coding ------------------->
<section id="intro" style="background-image:url(images/carrental.png)">
    ...
    <div class="text-center">
        <h6>Maximum duration : <span id="maxinput"></span> Hour(s)</h6><hr>
            ...
            <div class="container col-sm-4">
                <h1>
               <!--  <a href="/addBooking" class="btn btn-lg btn-success btn-block" id="proceed" disabled>Proceed</a> -->
               <a href="/addBooking" class="btn btn-lg btn-success btn-block">Proceed</a>
              </h1>
            </div>
